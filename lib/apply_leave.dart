...
class _ApplyLeaveState extends State<ApplyLeave> {
  ...
  Future<void> _fetchApprovers(String employeeId) async {
    try {
      final response = await http.get(
        Uri.parse('https://company-04bz.onrender.com/apply/approvers/$employeeId'),
      );
      if (response.statusCode == 200) {
  ...
  void _submitLeave() async {
    ...
    final url = isEditing
        ? 'https://company-04bz.onrender.com/apply/update/$employeeId/$leaveId'
        : 'https://company-04bz.onrender.com/apply/apply-leave';
