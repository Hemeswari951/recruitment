class RevisedPdfContentModel {
  ...
  RevisedPdfContentModel({
    // Page 1
    this.dearName = "Dear {fullName},",
    this.intro =
        "     This Revised Offer Letter serves as an official amendment to the employment offer previously issued to you. As part of our standard process and organizational restructuring, certain terms have been updated to better reflect your role and future progression at ZeAI Soft.",
    ...
    this.terminationPoint5 =
        "5. In the event the Employee resigns or discontinues employment during the training/internship period, the Employee shall be liable to reimburse the Company for the cost of training, which includes resources, mentoring, and administrative expenses incurred by the Company during the training program.",
    this.terminationPoint6 =
        "6. Employees must maintain strict confidentiality and professionalism, and are prohibited from discussing or sharing any company-related information on personal or unofficial platforms. Any unauthorized communication, gossip, or actions that harm the company’s reputation will result in disciplinary action.",
  ...
  // Factory constructor to create a RevisedPdfContentModel from a map (JSON)
  factory RevisedPdfContentModel.fromJson(Map<String, dynamic> json) {
    return RevisedPdfContentModel(
  ...
  // Method to convert a RevisedPdfContentModel instance to a map (JSON)
